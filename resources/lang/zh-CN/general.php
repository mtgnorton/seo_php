...
return [
    ...
    "Platform"                                  => "平台",
    "Cannot Chinese"                            => "不能为中文",
    "Collection depot"                          => "回收站",
    "Content warehouse"                         => "物料库",
    "Cache config"                              => "缓存设置",
    // 返回语句
    ...
    "Num"                                       => "数量",
    "Delete template group"                     => "删除分组",
    "Delete completed"                          => "彻底删除",
    "Delete recovered"                          => "恢复",
    "Group"                                     => "分组",
    // 帮助
    "Template type identify help"               => "抓取标识, 如果有多个, 一行一个",
    "English or pinyin"                         => "只能为字母",
    ...
    "Soft delete category help"                 => "确定删除吗 ? 如果删除后想恢复或者彻底删除, 请进入回收站进行操作",
    "Recover category help"                     => "恢复分类",
    "Recover template group help"               => "恢复分组",
    "Recover template help"                     => "恢复模板",
    "Delete success"                            => "删除成功",
    "File size and number limit"                => "总文件大小不大于200M, 总文件个数不大于200个。",
    "Image sum limit"                           => "总条数不超过500",
    "Article help"                              => "文章上传格式为: 标题******内容",
    ...
    "File too large"                            => "上传文件过大, 文件大小不能超过150M",
    "Is weight help"                            => "传递为301, 不传递为302",
    "From host"                                 => "出租前域名",
    "From url"                                  => "出租前网址",
    "To url"                                    => "出租后网址",
    "Spider attraction record"                  => "蜘蛛出租记录",
    "Spider attraction record"                  => "蜘蛛出租记录",
